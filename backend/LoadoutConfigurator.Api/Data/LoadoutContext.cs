...
public class LoadoutContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // can be accepted by many Components, and one Component can accept many types.
        modelBuilder.Entity<Component>()
            .HasMany(c => c.AcceptedAttachmentTypes)
            .WithMany()
            .UsingEntity("ComponentAcceptedAttachmentType");
    }
}
